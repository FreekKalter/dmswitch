...
## Development environment and release process
 ...
 - create virtualenv with Flask and dmswitch installed into it (latter is installed in
...
install it (`pip install dmswitch.tar.gz`), ensure that configuration file exists and
`DMSWITCH_SETTINGS` environment variable points to it, ensure that user has access to the
